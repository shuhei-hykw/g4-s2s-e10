...
Field maps stay outside the repository, and on a laptop they should
also stay outside any synced folder (iCloud Drive, Dropbox, ...):
they are hundreds of MB of binary that no sync engine handles well.
...
is needed for the E10 conf files -- 128 of them reference it.
